...
# SocketIO: gevent mode for production compatibility (avoid eventlet monkey-patch problems)
...
# -----------------------------
# 실행 (production: gunicorn -k gevent -w 1 app:app)
# -----------------------------
